  ...
  return (
    <>
      <div className="header">
        ...
        <div className="header__upper">
          <div className="header__upperheader"  style={{backgroundColor:headbg,boxShadow:shadow}}   >
            ...
            <div className="header__upperheadercenter"  style={{transform:`scaleX(${inputdisplay})`}}    >
              <LocationOn />
              <input type="text" placeholder="Ingresa tu comida favorita" />
            </div>
        ...
        <h1> Hambriento? Caor tiene tu comida favorita.  </h1> 
        <div className="header__centercenter">
            <div className="header__center1">
                <LocationOn   />
                <input type="text" placeholder="Ingresa tu restaurant o comida"    />
            </div>
            ...
            <div className="header__center3">
                <h3> Encuentra tu platillo especial </h3>
            </div>
        </div>
        <h3>  <span>Registrate</span> para crear tu menu favorito </h3> 
